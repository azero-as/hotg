    ...
    Widget _returnStartWorkoutButton(){
      return new Padding(
        ...
        child: RaisedButton(
          ...
          onPressed: () {
            Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => activeWorkoutSession(exercises: widget.exercises)));
          },
      ...
      return  Container(
          ...
          child: RichText(
              text: new TextSpan(
                  ...
                  children: <TextSpan>[
                    new TextSpan(text: 'Duration: ', style: new TextStyle(fontWeight: FontWeight.bold)),
                    ...
                    new TextSpan(text: 'Intensity: ', style: new TextStyle(fontWeight: FontWeight.bold)),
