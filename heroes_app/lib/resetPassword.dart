...
//---------FORM WIDGETS------------
    ...
    child: RaisedButton(
      ...
      onPressed: () {
        ...
        if (_isEmailSent){
          ...
          showDialog(context: context, builder: (context) => _onSendEmail(context));
          widget.readyToLogIn();
        }
      },
  ...
  void _validateAndSend() {
    ...
    if (_formKey.currentState.validate()) {
      ...
      this.widget.auth.forgotPassword(_email)
      .catchError((error) => {
        setState((){
  ...
  Widget _showErrorMessage() {
    if (_errorMessage.length > 0 && _errorMessage != null) {
      if (_errorMessage == "There is no user record corresponding to this identifier. The user may have been deleted."){
        return new Center(
          child: Text(
